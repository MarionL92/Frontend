...
const Layout = ({ children }) => {
    ...
    return (
        <div className="bg-[var(--bg-primary)]">
            {/* Header */}
            <header className="fixed top-6 left-4 right-4 md:left-1/2 md:-translate-x-1/2 md:w-[95%] md:max-w-6xl z-50 glass-card border border-[var(--glass-border)] rounded-2xl">
            ...
            <footer className="border-t border-[var(--glass-border)] py-3">
                <div className="container text-center">
                    <p className="text-sm text-[var(--text-muted)]">
                        PromptOptim — Green IT & Souveraineté des Données
                    </p>
                </div>
            </footer>
        </div>
